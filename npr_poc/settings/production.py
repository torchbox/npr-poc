...
GOOGLE_PICKER_API_KEY = os.getenv('WAGTAILCONTENTIMPORT_GOOGLE_PICKER_API_KEY', '')
GOOGLE_OAUTH_CLIENT_CONFIG = os.getenv('WAGTAILCONTENTIMPORT_GOOGLE_OAUTH_CLIENT_CONFIG', '')
MICROSOFT_CLIENT_ID = os.getenv('WAGTAILCONTENTIMPORT_MICROSOFT_CLIENT_ID', '')
