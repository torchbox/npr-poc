"""
Django settings for npr_poc project.
"""
import os
import sys
...
# Azure
AZURE_TEXT_ANALYTICS_API_KEY = env.get('AZURE_TEXT_ANALYTICS_API_KEY')
AZURE_TEXT_ANALYTICS_REGION = env.get('AZURE_TEXT_ANALYTICS_REGION')
